...
public class Size implements Serializable {
    ...
    @JoinTable(name = "product_size", //Tạo ra một join Table tên là "address_person"
            joinColumns = @JoinColumn(name = "size_id"),  // TRong đó, khóa ngoại chính là address_id trỏ tới class hiện tại (Address)
